...
##Move to dates section
# DataFrame Format Dates to 8 digits
#df_ddata1[df_ddata1['TRANSACTION_DT'].apply(lambda x: len(x) < 8)]
#df_ddata1['TRANSACTION_DT'] = df_ddata1['TRANSACTION_DT'].apply('{:0>8}'.format)
...
#Uncomment line below if sort is not working properly
#medianvals_by_date_df['TRANSACTION_DT'] = pd.to_numeric(medianvals_by_date_df['TRANSACTION_DT'], errors='coerce')
